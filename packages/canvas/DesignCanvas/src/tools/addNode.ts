...
const inputSchema = z.object({
  parentId: z.string().optional().describe('The id of the parent node. If not provided, the new node will be added to the root. if you don\'t know the parentId, you can use the tool "get_page_schema" to get the page schema. if you want to add to page root, just don\'t provide the parentId.'),
  newNodeData: z.lazy(() => nodeSchema).describe('The new node data.'),
  position: z.enum(['before', 'after']).optional().describe('The position of the new node. If not provided, the new node will be added to the end of the parent node.'),
  referTargetNodeId: z.string().optional().describe('The id of the reference target node. If not provided, the new node will be added to the end of the parent node. if you don\'t know the referTargetNodeId, you can use the tool "get_page_schema" to get the page schema. if you dont want to refer to any node, just don\'t provide the referTargetNodeId.'),
})
        ...
        content: [
          {
            ...
            value: {
              status: 'error',
              message: 'Component name is required, if you don\'t know the component name, you can use the tool "get_component_list" to get the component detail.'
            }
          }
        ]
      }
          ...
          content: [
            {
              ...
              value: {
                status: 'error',
                message: 'Parent node not found, please check the parentId is correct. if you don\'t know the parentId, you can use the tool "get_page_schema" to get the page schema. if you want to add to page root, just don\'t provide the parentId.'
              }
            }
          ]
        }
          ...
          content: [
            {
              ...
              value: {
                status: 'error',
                message: 'Refer target node not found, please check the referTargetNodeId is correct. if you dont want to refer to any node, just don\'t provide the referTargetNodeId.'
              }
            }
          ]
        }
