...
const inputSchema = z.object({
  ...
  props: z.object({}).describe('The props of the component. if you don\'t know available props, you can use the "get_component_detail" tool to get component detail and available props.'),
